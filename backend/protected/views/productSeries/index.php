...
<div class="heading">
	<h1><?php echo CHtml::image(Yii::app()->baseUrl . '/image/product.png'); ?>产品系列</h1>
	<div class="buttons">
		<?php if (Yii::app()->user->checkAccess('createProductSeries')) { ?>
	...
	<div class="clearfix">
		...
		<?php $this->widget('zii.widgets.grid.CGridView', array(
			...
			'columns' => array(
				...
				array(
					'name' => 'series_model',
					'value' => '$data->series_model',
					'headerHtmlOptions' => array('style' => 'width:25%;'),
					'type' => 'html'
				),
				array(
					'name' => 'category_id',
					'value' => '$data->category_id > 0 && empty($data->category) == false  ? $data->category->name : "未知"',
				...
				array(
					...
					'buttons' => array(
						'update' => array(
							...
							'visible' => 'Yii::app()->user->checkAccess("updateProductSeries")'
						),
						'delete' => array(
							'visible' => 'Yii::app()->user->checkAccess("deleteProductSeries")'	
						)
					)					
				)
			)
		...
		<?php if (Yii::app()->user->checkAccess('deleteProductSeries')) { ?>
