...
class Zend_Search_Lucene_Search_QueryLexer extends Zend_Search_Lucene_FSM {
	...
	public function __construct() {
		...
		$quoteWithinLexemeErrorAction = new Zend_Search_Lucene_FSMAction(
				$this, 'quoteWithinLexemeErrException');
		...
		$this->addTransitionAction(self::ST_QUOTED_LEXEME,
				self::ST_WHITE_SPACE, $addQuotedLexemeAction);
	...
	public function addQuerySyntaxLexeme() {
		...
		$token = new Zend_Search_Lucene_Search_QueryToken(
				...
				$lexeme, $this->_queryStringPosition);
